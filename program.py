...
# find products with price lower or equal 0 and greater than 1000000
incorrect_products = product_data[ (product_data["price"] <= 0) | (product_data["price"] > 1000000) ].index
